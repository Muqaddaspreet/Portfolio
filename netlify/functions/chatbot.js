...
EXPERIENCE:
- **Software Engineer at Nagarro** (Jun 2021 - Jul 2023): Delivered supplier/admin modules for Tungsten e-invoicing portal with lazy loading, route-level code splitting, and image optimization. Integrated REST APIs with client-side caching to enhance responsiveness and reduce redundant calls, supporting suppliers across 175+ countries. Wrote unit tests to maintain strong coverage for new modules; contributed to bug bashes and code reviews, building dashboards for visualization strengthening release quality. Skills- Software Design Patterns · Data Science · Web development · Unit Testing · Data Modeling · GitHub Actions · Git · SOLID Design Principles · Integration Testing

- **Fullstack Developer Intern at VMM Education** (Jan 2021 - Jun 2021): Developed a web-based quiz module that helped students practice and engage with learning material more easily. Improved the application's navigation and user experience by organizing data flow and reducing repetitive actions. Strengthened the system's reliability by creating automated tests to catch issues before release. Skills- React · Redux · JavaScript · Jest · Node.js · Express · Mongodb · Mongoose · API Integration · Unit Testing · Integration Testing
