...
export const Skills = [
  ...
  {
    title: "Databse & Cloud",
    skills: [{ name: "MySQL" }, { name: "MongoDB" }, { name: "S3" }],
  },
  {
    title: "ML Libraries",
    skills: [
...
export const Experiences = [
  ...
  },
  {
    ...
    desc: "Collaborated cross-functionally and demonstrated Amazon’s Bias for Action by consistently exceeding daily fulfillment targets. Reinforced Amazon’s Customer Obsession by ensuring 100% accuracy in high-priority shipments.",
    skills: [
      "Python",
      "Socket Programming",
      "Time Management",
...
export const Research_data = [
  {
    ...
    title: "Transient Noise Reduction in Speech Signals",
    institution: "Concordia University",
    date: "2024",
    desc: "Explored deep learning approaches (FNN, CNN, RNN) to reduce transient noises such as claps, coughs, and clicks in speech signals. The project compared different neural architectures for noise suppression, evaluated performance across multiple metrics, and produced both a detailed paper and presentation.",
    skills: [
      "Python",
      "PyTorch",
      "Deep Learning",
    ...
    links: {
      report:
        "https://github.com/Muqaddaspreet/Transient-Noise_Reduction/blob/main/Transient%20Noise%20Reduction.pdf",
  ...
  },
  {
    ...
    institution: "Concordia University",
    date: "2024",
    desc: "Investigated multiple energy functions (e1, eEntropy, Gradient) for content-aware image resizing. Implemented seam carving, pixel update techniques, and cropping/upscaling methods to preserve image details while resizing. Results and comparisons were documented in a research paper.",
    skills: [
      "Python",
      "Computer Vision",
      "Image Processing",
    ...
    links: {
      report:
        "https://github.com/Muqaddaspreet/Content-Aware-Image-Resizing/blob/main/Project_Report-Content-Aware_Image_Resizing.pdf",
      github: "https://github.com/Muqaddaspreet/Content-Aware-Image-Resizing",
    },
  },
  {
    id: 2,
    ...
    links: {
      report:
        "https://github.com/Muqaddaspreet/Longest-Simple-Path/blob/main/Project_Report-Longest-Simple-Path-Heuristic-Algorithms.pdf",
      github: "https://github.com/Muqaddaspreet/Longest-Simple-Path",
    },
  },
];
...
export const Education_data = [
  {
    ...
    grade: "3.30 GPA",
    degree: "MApSompSc - Masters in Applied Computer Science",
  },
  {
    id: 1,
    ...
    grade: "3.56 GPA",
    degree: "1-Year Full-Time Diploma in French",
  },
  {
    id: 2,
    img: "https://upload.wikimedia.org/wikipedia/en/1/1a/Guru_Nanak_Dev_University_Logo.png",
